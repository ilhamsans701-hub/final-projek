                ...
                <div class="col-md-4 text-center mb-4">
                    <div class="mb-3">
                        <?php
                            ...
                            $defaultAvatar = 'https://ui-avatars.com/api/?name=' . urlencode($username) . '&background=4f46e5&color=fff&size=150';
                            if (!empty($photoName)) {
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="invalid-feedback">
                                Nama harus diisi (3-50 karakter).
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="Orang Tua" readonly
